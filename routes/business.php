...
Route::middleware(["auth", "role:business", "web"])->prefix("business")->name("business.")->group(function () {
    ...
    Route::post('/projects/{project}/products/select', [ProjectController::class, 'selectProduct'])->name('projects.products.select');
    Route::post('/projects/{project}/items/store-existing', [ProjectController::class, 'storeExistingItem'])->name('projects.items.store-existing');
    Route::post('/projects/{project}/items/store-manual', [ProjectController::class, 'storeManualItem'])->name('projects.items.store-manual');
    Route::post('/projects/{project}/items/{itemId}/supplier-cost', [ProjectController::class, 'addSupplierCost'])->name('projects.items.add-supplier-cost');
    Route::post('/projects/{project}/items/{itemId}/delete', [ProjectController::class, 'deleteItem'])->name('projects.items.delete');
    Route::post('/projects/{project}/costing', [ProjectController::class, 'updateCosting'])->name('projects.costing.update');
    Route::post('/projects/{project}/prepare-quotation', [ProjectController::class, 'prepareQuotation'])->name('projects.prepare-quotation');
    Route::get('/projects/{project}/comparison-pdf', [ProjectController::class, 'comparisonPdf'])->name('projects.comparison-pdf');
    Route::get('/projects/{project}/costing-pdf', [ProjectController::class, 'costingPdf'])->name('projects.costing-pdf');
    ...
    Route::prefix("received-documents")->name("received-documents.")->group(function () {
        ...
        Route::delete("/{codGeneracion}", [DTERecibidoController::class, "destroy"])->name('destroy');
        Route::get("/download-pdf/{codGeneracion}", [DTERecibidoController::class, "downloadPdf"])->name('download-pdf');
        Route::get("/manual-upload", [DTERecibidoController::class, "manualUploadIndex"])->name('manual-upload.index');
        Route::post("/manual-upload", [DTERecibidoController::class, "manualUploadStore"])->name('manual-upload.store');
