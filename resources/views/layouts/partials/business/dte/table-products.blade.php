                    ...
                    <x-tr>
                        ...
                        <x-td :last="true">
                            <x-button type="button" icon="trash" size="small"
                                data-action="{{ Route('business.dte.product.delete', $product['id']) }}" typeButton="danger"
                    ...
                    <div class="flex items-center justify-end">
                        <div class="me-10">
                            <x-input type="checkbox" label="¿Retener IVA?" name="retener_iva"
                                ...
                                :checked="isset($dte['retener_iva']) && $dte['retener_iva'] === 'active'" class="retener"
                                data-type="iva" />
                        </div>
                        <div class="flex items-center justify-end gap-4 text-end">
                            Retención IVA (1%)
                        ...
                        <div class="flex items-center justify-end">
                            <div class="me-10">
                                <x-input type="checkbox" label="¿Percibir IVA?" name="percibir_iva"
                                    ...
                                    :checked="isset($dte['percibir_iva']) && $dte['percibir_iva'] === 'active'"
                                    class="retener" data-type="percibir_iva" />
                            </div>
                            <div class="flex items-center justify-end gap-4 text-end">
                                Percibir IVA (1%)
                                <span>
