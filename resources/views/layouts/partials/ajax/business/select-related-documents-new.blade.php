       <x-select label="Documento relacionado" name="documento_relacionado" id="documento_relacionado_new" :required="isset($dte['documentos_relacionados']) && count($dte['documentos_relacionados']) > 0"
