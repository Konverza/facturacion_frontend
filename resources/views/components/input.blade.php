    ...
    <div class="relative w-full">
        ...
        @elseif ($type === 'checkbox')
            <input type="checkbox" value="{{ $value }}" name="{{ $name }}" id="{{ $id }}"
                ...
                class="{{ $class }} h-4 w-4 rounded border-2 border-gray-300 bg-gray-100 text-primary-500 focus:ring-2 focus:ring-primary-500 dark:border-gray-800 dark:bg-gray-950 dark:text-primary-300 dark:ring-offset-gray-800 dark:focus:ring-primary-300">
            <label for="{{ $id }}"
        ...
        @elseif($type === 'file')
            <span
                class="mb-1 block text-sm font-medium text-gray-500 after:ml-0.5 after:text-red-500 after:content-['*'] dark:text-gray-300">
                {{ $label }}:
            </span>
            <div
                class="flex flex-col items-start justify-between overflow-hidden rounded-lg border border-dashed border-gray-300 dark:border-gray-800">
                <div class="flex w-full justify-between">
                    <div class="flex items-center gap-2">
                        <label for="{{ $id }}"
                            class="flex cursor-pointer items-center gap-1 text-nowrap border-e border-dashed border-gray-300 px-4 py-2.5 text-sm text-gray-600 hover:bg-gray-100 dark:border-gray-800 dark:text-gray-300 dark:hover:bg-gray-900/50">
