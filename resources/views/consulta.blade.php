            ...
            @if(isset($dte))
                <div class="mt-5">
                    <div class="mb-5 border-b border-gray-300 dark:border-gray-600">
                        <p class="text-base text-gray-600 dark:text-gray-300">Tipo de Documento:</p>
                        <p class="text-gray-800 dark:text-gray-200 font-semibold">{{ $tipos_dte[$dte["tipo_dte"]] }}</p>
                    </div>
                    <div class="mb-5 border-b border-gray-300 dark:border-gray-600">
                        <p class="text-base text-gray-600 dark:text-gray-300">Código de generación:</p>
                        <p class="text-gray-800 dark:text-gray-200 font-semibold">{{ $dte["codGeneracion"] }}</p>
                    </div>
                    <div class="mb-5 border-b border-gray-300 dark:border-gray-600">
                        <p class="text-base text-gray-600 dark:text-gray-300">Número de Control:</p>
                        <p class="text-gray-800 dark:text-gray-200 font-semibold">{{ $dte["documento"]["identificacion"]["numeroControl"] }}</p>
                    </div>
                    <div class="mb-5 border-b border-gray-300 dark:border-gray-600">
                        <p class="text-base text-gray-600 dark:text-gray-300">Sello de Recibido:</p>
                        <p class="text-gray-800 dark:text-gray-200 font-semibold">{{ $dte["selloRecibido"] ?? "N/A" }}</p>
                    </div>
                    <div class="mb-5 border-b border-gray-300 dark:border-gray-600">
                        <p class="text-base text-gray-600 dark:text-gray-300">Fecha de Procesamiento:</p>
                        <p class="text-gray-800 dark:text-gray-200 font-semibold">{{ \Carbon\Carbon::parse($dte["fhProcesamiento"])->format('d/m/Y H:i:s') }}</p>
                    </div>
                    <div class="mb-5 border-b border-gray-300 dark:border-gray-600">
                        <p class="text-base text-gray-600 dark:text-gray-300">Estado:</p>
                        <p class="text-gray-800 dark:text-gray-200 font-semibold">{{ $dte["estado"] }}</p>
                    </div>
