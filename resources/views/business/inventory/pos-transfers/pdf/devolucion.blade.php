...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header h1 { font-size: 20px; color: #1e40af; margin-bottom: 3px; }
        .header .subtitle { font-size: 14px; color: #1e3a8a; font-weight: bold; }
        .header p { font-size: 12px; color: #666; }
        .alert-box { background: #eff6ff; border-left: 4px solid #1e40af; padding: 10px; margin: 12px 0; }
        .alert-box h3 { color: #1e3a8a; font-size: 13px; margin-bottom: 5px; }
        .alert-box p { font-size: 11px; color: #1e3a8a; line-height: 1.4; }
        ...
        .info-label { font-weight: bold; width: 30%; background: #dbeafe; }
        ...
        th { background: #1e40af; color: white; padding: 6px; text-align: left; font-size: 10px; font-weight: bold; }
        ...
        .totals .total-final { font-weight: bold; font-size: 13px; background: #eff6ff; border-top: 2px solid #1e40af; }
    ...
    <div class="container">
        ...
        <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 12px; margin: 15px 0;">
            ...
            <p style="font-size: 11px; color: #78350f; line-height: 1.4;">
                Esta devolución requiere un proceso de liquidación donde se debe verificar la cantidad real recibida de cada producto.
        ...
        <div style="background: #dcfce7; border-left: 4px solid #16a34a; padding: 12px; margin: 15px 0;">
            ...
            <p style="font-size: 11px; color: #14532d; line-height: 1.4;">
                La liquidación de esta devolución ha sido completada. Consulte el reporte de liquidación para ver el detalle de diferencias.
            </p>
        </div>
        @endif
