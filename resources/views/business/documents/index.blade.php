                                            ...
                                            @if ($invoice['estado'] !== 'RECHAZADO')
                                                <div class="relative">
                                                    <x-button type="button" icon="arrow-down" typeButton="primary" text="Acciones"
                                                        class="show-options" data-target="#options-dtes-{{ $loop->iteration }}" size="small" />
                                                            ...
                                                            @if ($invoice['estado'] !== 'ANULADO')
                                                                ...
                                                                <li>
                                                                    <button type="button"
                                                                        ...
                                                                        data-target="#anular-dte" data-id="{{ $invoice['codGeneracion'] }}">
                                                                        <x-icon icon="x" class="h-4 w-4" />
                                                                        Anular
                                                                    </button>
                                                                </li>
                    ...
                    <div class="flex flex-col">
                        ...
                        <form action="{{ Route('business.dte.send-email') }}" method="POST">
                            ...
                            <div
                                ...
                                <x-button type="button" class="hide-modal" text="Cancelar" icon="x" typeButton="secondary"
                                    data-target="#send-email" />
                                <x-button type="submit" text="Reenviar correo" icon="email-forward" typeButton="primary" />
                            </div>
                        </form>
                    </div>
                </div>
