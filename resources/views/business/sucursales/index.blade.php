    ...
    <section class="my-4 px-4 sm:px-6">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <div class="options absolute right-0 top-0 z-10 mt-1 hidden w-max rounded-lg border border-gray-300 bg-white p-2 dark:border-gray-800 dark:bg-gray-950"
                                                        ...
                                                        <ul class="flex flex-col text-xs">
                                                            <li>
                                                                <a href="{{ Route('business.puntos-venta.index', [$business->id, $sucursal->id]) }}"
                                                            ...
                                                            <li>
                                                                <button type="button"
                                                                    data-url="{{ Route('business.sucursales.edit', [$business->id, $sucursal->id]) }}"
                                                                    data-action="{{ Route('business.sucursales.update_sucursal', [$business->id, $sucursal->id]) }}"
                                                            ...
                                                            <li>
                                                                <form
                                                                    action="{{ Route('business.sucursales.delete_sucursal', [$business->id, $sucursal->id]) }}"
                                                                    method="POST"
        ...
        <div id="new-sucursal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative max-h-full w-full max-w-xl p-4">
                <form action="{{ route('business.sucursales.store_sucursal', $business->id) }}" method="POST">
                    @csrf
                    <!-- Modal content -->
                    <div
        ...
        <div id="edit-sucursal" tabindex="-1" aria-hidden="true"
            class="fixed left-0 right-0 top-0 z-50 hidden h-full max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden bg-gray-200/50 dark:bg-gray-900/50 md:inset-0">
            <div class="relative max-h-full w-full max-w-xl p-4">
                <form action="{{ Route('business.index') }}" method="POST" id="form-edit-sucursal">
                    @csrf
                    @method('PUT')
                    <!-- Modal content -->
                    <div
