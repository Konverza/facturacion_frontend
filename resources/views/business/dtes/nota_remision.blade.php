        ...
        <form action="{{ Route('business.dte.nota-remision') }}" method="POST">
            ...
            <div class="mt-4">
                        ...
                        <div id="default-styled-tab-content">
                            <div class="hidden" id="styled-receptor" role="tabpanel" aria-labelledby="receptor-tab">
                                ...
                                <div class="mt-4" id="datos-receptor">
                                    ...
                                    <div class="mt-4 flex gap-4">
                                        <div class="flex-1">
                                            <x-select name="bienTitulo" label="Bienes remitidos a título de" id="bienTitulo" required
                                                :options="$bienTitulo ?? [
                                                    'Seleccione una opción' => 'Seleccione una opción',
                                                ]"
                                                selected="{{ old('bienTitulo',  '') }}"
                                                value="{{ old('bienTitulo',  '') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                @include('layouts.partials.business.dte.sections.section-otra-informacion', [
                    ...
                    "otros_documentos_asociados" => false
                ])
                @include('layouts.partials.business.dte.sections.section-productos', [
                    'title' => 'Detalle de nota de remisión',
                ])
