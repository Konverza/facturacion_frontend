...
@section('title', 'Generar nota de crédito')
@section('content')
    <section class="my-4 pb-4">
        @include('layouts.partials.business.dte.header', ['title' => 'Generar nota de crédito'])
        <form action="{{ Route('business.dte.nota-credito') }}" method="POST">
            @csrf
