...
@section('content')
                            ...
                            @foreach ($business_customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('business.clientes.destroy', $customer->id) }}"
                                            method="POST" class="d-inline frm-delete">
                                            @csrf
                                            @method('DELETE')
    ...
    <div class="modal modal-lg fade" id="aggCliente" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label for="codActividad">Actividad
                                Económica:</label>
                            <input type="text" name="codActividad" id="codActividad" class="form-control"
                                autocomplete="off">
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="form-group mb3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="clienteExportacion">
                        ...
                        <div class="row" id="personaExportacion">
                            <div class="col">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="codPais" name="codPais"
                                        autocomplete="off">
                                </div>
                            </div>
                            <div class="col">
